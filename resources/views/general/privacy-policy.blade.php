...
<html lang="pt-BR">
  <head>
    ...
    <link
      rel="shortcut icon"
      href="/resources/assets/images/logos/logo-white-colors.png"
      type="image/x-icon"
    />
  ...
  <header class="shadow bg-white py-3">
        ...
        >
          ...
          <div class="text-gray-700 flex flex-col gap-y-3">
            ...
            >
              ...
              <a
                href="/app/Views/auth/register.html"
    ...
    <!-- Conteúdo principal -->
    <section
      class="max-w-4xl mb-18 mx-auto bg-white p-8 mt-10 shadow rounded-xl"
    >
      <div>
  ...
  <footer class="py-18 bg-white shadow border-t border-gray-200">
    <div class="container mx-auto px-4">
      ...
      >
        ...
        <a
          href="/app/Views/general/privacy-policy.html"
          class="text-gray-500 hover:text-cyan-500 duration-300 ease-in-out"
        >
          Política de Privacidade
        </a>
