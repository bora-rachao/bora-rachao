...
@section('content')
    ...
    <section class="container px-4 mx-auto">
        <div class="md:flex items-center group">
            ...
            <div>
                <img class="md:-ms-5 group-hover:md:ms-0 object-cover border-5 border-b-orange-500 border-l-cyan-500 border-r-amber-500 border-t-lime-500 rounded-4xl w-400 duration-300 ease-in-out"
                    src='{{ asset('assets/images/team-bora-rachao.jpg') }}' alt="Time BoraRachão" />
            </div>
        </div>
    </section>
    ...
    <section class="container px-4 mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 group">
            <div
                ...
                <div class="my-4 flex flex-wrap justify-center md:justify-start gap-2">
                    <a class="flex items-center rounded-full bg-cyan-500 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.linkedin.com/in/eullerlourenco/">
                        <i class="fa-brands fa-linkedin-in py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-pink-600 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.instagram.com/eullerls_/">
                        <i class="fa-brands fa-instagram py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-gray-800 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://github.com/eullerlourenco">
                        <i class="fa-brands fa-github py-3 px-3.25"></i>
                    </a>
                </div>
            </div>
            <div class="py-2 flex justify-center md:justify-start z-10 items-center">
                <img class="h-64 w-64 md:-ms-5 group-hover:md:ms-0 rounded-4xl object-cover border-5 border-cyan-500 duration-300 ease-in-out"
                    src='{{ asset('assets/images/eullerls.jpeg') }}' alt="eullerls" />
            </div>
        </div>
    </section>
    ...
    <section class="container px-4 mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 group">
            <div class="py-2 flex justify-center md:justify-end z-10 items-center">
                <img class="h-64 w-64 md:-me-5 group-hover:md:me-0 rounded-4xl object-cover border-5 border-lime-500 duration-300 ease-in-out"
                    src='{{ asset('assets/images/lucasbardeli.jpg') }}' alt="lucasbardeli" />
            </div>
            <div class="px-2 py-4 col-span-3 lg:p-10 text-center border border-gray-300 shadow-lg rounded-3xl">
                <h2 class="text-4xl text-start text-gray-600 rounded-xl">
                    Lucas Bardeli
                </h2>
                <div class="bg-linear-to-r from-lime-500 to-cyan-500 py-0.5 my-3.5 w-full"></div>
                ...
                <div class="my-4 flex flex-wrap justify-center md:justify-start gap-2">
                    <a class="flex items-center rounded-full bg-cyan-500 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.linkedin.com/in/lucas-bardeli/">
                        <i class="fa-brands fa-linkedin-in py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-pink-600 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.instagram.com/lucas.bardeli/">
                        <i class="fa-brands fa-instagram py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-gray-800 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://github.com/lucas-bardeli">
                        <i class="fa-brands fa-github py-3 px-3.25"></i>
                    </a>
                </div>
            </div>
    ...
    <section class="container px-4 mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 group">
            <div
                ...
                <div class="bg-linear-to-r from-amber-400 to-orange-500 py-0.5 my-3.5 w-full"></div>
                <p class="text-xl text-gray-600 indent-8 text-start">
                ...
                <div class="my-4 flex flex-wrap justify-center md:justify-start gap-2">
                    <a class="flex items-center rounded-full bg-cyan-500 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.linkedin.com/in/joão-francisco-fabbri-fonseca/">
                        <i class="fa-brands fa-linkedin-in py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-pink-600 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.instagram.com/jf.fonsecaa_/">
                        <i class="fa-brands fa-instagram py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-gray-800 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://github.com/JoaoFonseca4">
                        <i class="fa-brands fa-github py-3 px-3.25"></i>
                    </a>
                </div>
            </div>
            <div class="py-2 flex justify-center md:justify-start z-10 items-center">
                <img class="h-64 w-64 md:-ms-5 group-hover:md:ms-0 rounded-4xl object-cover border-5 border-orange-500 duration-300 ease-in-out"
                    src='{{ asset('assets/images/joaofran.jpg') }}' alt="João Francisco" />
            </div>
        </div>
    </section>
    ...
    <section class="container px-4 mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 group">
            <div class="py-2 flex justify-center md:justify-end z-10 items-center">
                <img class="h-64 w-64 md:-me-5 group-hover:md:me-0 rounded-4xl object-cover border-5 border-amber-400 duration-300 ease-in-out"
                    src='{{ asset('assets/images/gabribeiro.jpg') }}' alt="gabribeiro" />
            </div>
            <div class="px-2 py-4 col-span-3 lg:p-10 text-center border border-gray-300 shadow-lg rounded-3xl">
                <h2 class="text-4xl text-start text-gray-600 rounded-xl">
                    Gabriel Ribeiro
                ...
                <div class="my-4 flex flex-wrap justify-center md:justify-start gap-2">
                    <a class="flex items-center rounded-full bg-cyan-500 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.linkedin.com/in/gabriel-alexandre-ribeiro-97950026a/">
                        <i class="fa-brands fa-linkedin-in py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-pink-600 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.instagram.com/gabrielalexas/">
                        <i class="fa-brands fa-instagram py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-gray-800 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://github.com/Gabriel-Ribeiro2">
                        <i class="fa-brands fa-github py-3 px-3.25"></i>
                    </a>
                </div>
            </div>
    ...
    <section class="container px-4 mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-4 group">
            <div
                ...
                <div class="bg-linear-to-r from-orange-500 to-red-500 py-0.5 my-3.5 w-full"></div>
                <p class="text-xl text-gray-600 indent-8 text-start">
                ...
                <div class="my-4 flex flex-wrap justify-center md:justify-start gap-2">
                    <a class="flex items-center rounded-full bg-cyan-500 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.linkedin.com/in/beatriz-monteiro-808b86352">
                        <i class="fa-brands fa-linkedin-in py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-pink-600 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://www.instagram.com/beatrizkmonteiro_/">
                        <i class="fa-brands fa-instagram py-3 px-3.25"></i>
                    </a>
                    <a class="flex items-center rounded-full bg-gray-800 text-xl text-white hover:scale-[1.02] duration-300 ease-in-out"
                        target="_blank" href="https://github.com/beatrizmonteiro014">
                        <i class="fa-brands fa-github py-3 px-3.25"></i>
                    </a>
                </div>
            </div>
            <div class="py-2 flex justify-center md:justify-start z-10 items-center">
                <img class="h-64 w-64 md:-ms-5 group-hover:md:ms-0 rounded-4xl object-cover border-5 border-red-500 duration-300 ease-in-out"
                    src='{{ asset('assets/images/beaamonteiro.jpg') }}' alt="beaamonteiro" />
            </div>
        </div>
    </section>
